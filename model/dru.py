...
class druv2(nn.Module):
    def __init__(self,
        ...
        self.hidden_size = int(hidden_size * 16 / self.feature_scale)
        ...
        # downsampling
        self.conv1 = unetConv2(self.in_channels + 1, filters[0], self.is_batchnorm, dropout_rate=self.dropout_rate)
        # self.conv1 = unetConv2(self.in_channels + self.n_classes, filters[0], self.is_batchnorm, dropout_rate=self.dropout_rate)
        self.maxpool1 = nn.MaxPool2d(kernel_size=2)

        self.conv2 = unetConv2(filters[0], filters[1], self.is_batchnorm, dropout_rate=self.dropout_rate)
        self.maxpool2 = nn.MaxPool2d(kernel_size=2)

        self.conv3 = unetConv2(filters[1], filters[2], self.is_batchnorm, dropout_rate=self.dropout_rate)
        self.maxpool3 = nn.MaxPool2d(kernel_size=2)

        self.conv4 = unetConv2(filters[2], filters[3], self.is_batchnorm, dropout_rate=self.dropout_rate)
